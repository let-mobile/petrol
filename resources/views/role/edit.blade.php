  ...
  <div class="card card-form">
      <div class="row no-gutters">
          ...
          <div class="col-lg-8 card-form__body card-body">
              ...
              <form method="POST" id="validate-form" enctype="multipart/form-data" action="{{ url('roles')}}/{{$role->id }}">
                  @csrf
                  @method('PUT')
                  <div class="col-12 col-md-10 mb-3">
                      <label for="name" class="required">Title</label>
                      <input type="text" class="form-control" id="title" placeholder="Enter Payment Plan Title" name="name" value="{{$role->name ?? ''}}">
